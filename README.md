- [도토리 DO our sTORI](#도토리-do-our-stori)
- [서비스 개요](#서비스-개요)
    + [서비스 설명](#서비스-설명)
    + [타겟](#타겟)
    + [기획 배경 및 기대 효과](#기획-배경-및-기대-효과)
- [프로젝트 산출물](#프로젝트-산출물)
    + [요구사항 정의서](#요구사항-정의서)
    + [Wireframe](#wireframe)
...
- [프로젝트 진행](#프로젝트-진행)
    ...
    + [Jira](#jira)
    + [Git](#git)
- [서비스 화면 및 기능 소개](#서비스-화면-및-기능-소개)
    + [메인 페이지](#메인-페이지)
    + [로그인 페이지](#로그인-페이지)
    + [마이페이지-내 정보](#마이페이지-내-정보)
    + [마이페이지-보관함](#마이페이지-보관함)
    + [책 리스트 페이지](#책-리스트 페이지)
    + [방 목록 페이지](#방-목록-페이지)
    + [방 생성 페이지](#방-생성-페이지)
    + [대기방-방장 화면](#대기방-방장-화면)
    + [대기방-참여자 화면](#대기방-참여자-화면)
    + [연극방](#연극방)
    + [연극 종료](#연극-종료)
- [기술 스택](#기술-스택)
- [화상 연결 기술](#화상-연결-기술)
    ...
    + [OpenVidu](#openvidu)
    + [3D 모델](#3d-모델)
    + [Blender(Shape Key)](#blender-shape-key-)
