...
<template>
    <div class="row header-bg q-pt-sm q-pb-sm" style="background: #ffffff">
        <!--    로고-->
        <div
            class="col-2 offset-0 flex justify-center items-center"
        ...
        <div class="col-4 offset-2 flex justify-center items-center">
            ...
            >
                <img
                    src="../../assets/DotoriImages/dotorisq.png"
                    alt="logo"
                    width="40%"
                    @click="moveMainPage"
                />
        ...
        <div
            class="col-2 flex items-center justify-end npsfont"
        ...
        <div
            class="col-2 flex items-center justify-center npsfont"
            v-if="isAuthenticated"
        >
            <q-btn flat class="text-h6 q-ma-none" color="brand" @click="logout"
