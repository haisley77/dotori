...
<template>
  <div class="row header-bg q-pt-sm q-pb-sm" style="background: #ffffff">
    ...
    <div class="col-4 offset-0 flex justify-center items-center">
      <img src="../../assets/DotoriImages/dotorisq.png" style="transform: translate(155px,0px); cursor:pointer" alt="logo" width="30%" @click="moveMainPage"/>
    </div>

    <div class="col-2 flex items-center justify-end npsfont" v-if="ovstore.isLoggedIn">
      <q-btn flat class="text-h7 q-ma-none" style="transform: translate(150px,0px)" color="brand" @click="moveListPage">
        <span style="color: black">시작하기</span>&nbsp&nbsp
